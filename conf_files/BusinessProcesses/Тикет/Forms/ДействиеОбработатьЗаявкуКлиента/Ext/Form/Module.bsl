...
Процедура ПрочитатьРеквизитыБизнесПроцесса()
	...
	Заказчик = ЗаданиеОбъект.Заказчик;
	ЗаданиеСодержание = ЗаданиеОбъект.Содержание.Получить();
	
	УстановитьПривилегированныйРежим(Ложь);

	ПодразделенияПартнера.Параметры.УстановитьЗначениеПараметра("Тикет", ЗадачаОбъект.БизнесПроцесс);
...
&НаКлиенте
Процедура ПодразделенияПартнераВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
