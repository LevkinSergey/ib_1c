...
Процедура ПриЗаписиПользователяИнформационнойБазы(Знач СтарыеСвойства, Знач НовыеСвойства) Экспорт
	...
	//Rr_{
	если ЗначениеЗаполнено(СтарыеСвойства.Имя) тогда
		редактируемыйПользователь = пользователи.НайтиПоИмени(НовыеСвойства.Имя);
		ПользовательскиеЗначенияПоУмолчаниюСервер.ДобавитьОтсутствующиеНастройкиПользователяВРегистр(редактируемыйПользователь);
	КонецЕсли;	
	//}Rr_
